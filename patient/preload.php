...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/template-preload.css"/> <!--Meu template-->
            ...
            <div class="menu">
                <nav>
                    ...
                    <ul>
                        ...
                        <li><a href="../doctor.html">Quero ser um colaborador</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
<!--==================================BANNER==================================-->
    <section id="banner">
        <div class="container">
            <div class="banner-left"><img src="images/banner-illustration.png"></div>
            <div class="banner-right column">
                <div class="banner-right-title">Aguarde para ser atendido sua posição na fila é  <a href="chat.php">1</a>.</div> <!--TEMPORARIO SOMENTE PARA DESENVOLVIMENTO DO FRONTEND-->
