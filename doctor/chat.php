            ...
            <div class="menu">
                <nav>
                    ...
                    <ul>
                        ...
                        <li><a href="../doctor.html">Meu perfil</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <section id="chat">
        <div class="container">
            <div class="chat-left column">
                <div class="chat-left-top">Próximos pacientes</div>
                ...
                <div class="chat-left-body">
                    <div class="chat-left-body-person active-chat">
                        ...
                        <div class="chat-left-body-person-name">Willian marques</div>
                    </div>
                    <div class="chat-left-body-person">
                        <div class="chat-left-body-person-picture"></div>
                        <div class="chat-left-body-person-name">Caio freitas</div>
                    </div>
                    <div class="chat-left-body-person">
                        <div class="chat-left-body-person-picture"></div>
                        <div class="chat-left-body-person-name">Leandra mattos</div>
                    </div>
                    <div class="chat-left-body-person">
                        <div class="chat-left-body-person-picture"></div>
                        <div class="chat-left-body-person-name">Willian marques</div>
            ...
            <div class="chat-right">
                <div class="chat-right-top">
                    <div class="chat-right-top-title">Gabriel de Jesus</div>
                    <div class="chat-right-top-tag">Clinico geral</div>
                </div>
